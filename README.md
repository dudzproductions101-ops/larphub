...
[![Discord](https://img.shields.io/badge/Discord-Join%20the%20server-5865F2?style=for-the-badge&logo=discord&logoColor=white)](#)
...
<a href="https://github.com/realv1sta/larphub/graphs/contributors">
...
| Contribution | Credit |
|---|---|
| 🖼️ **Walls Collection** (`/walls`) | Community wallpaper submissions — see the folder for the full gallery |
| 👑 **Creator & Maintainer** | [**@realv1sta**](https://github.com/realv1sta) — created and maintains `larphub` and the `chmod +x larp` server |
